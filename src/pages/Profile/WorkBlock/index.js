  ...
  <div className="w3-container w3-card w3-white w3-margin-bottom">
    ...
    {experience.map((work) => (
      <div className="w3-container" key={work.id}>
        <h5 className="w3-opacity"><b>{work.title} / {work.company}</b></h5>
        <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>{work.dates.toString()}</h6>
        <Markdown>
          {work.description}
        </Markdown>
        <hr />
